...
const ManageAdmins = () => {
  ...
  const fetchCurrentAdmin = async () => {
    const res = await axios.get('http://localhost:5002/api/admin/me', {
  ...
  const fetchAdmins = async () => {
    try {
      const res = await axios.get('http://localhost:5002/api/admin/admins', {
        headers: { Authorization: `Bearer ${token}` }
      });
      setAdmins(res.data);
    } catch (err) {
  ...
  const handleCreate = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:5002/api/admin/admins', form, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleUpdate = async (id) => {
    try {
      await axios.put(`http://localhost:5002/api/admin/admins/${id}`, editData[id], {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Delete this admin?')) {
      await axios.delete(`http://localhost:5002/api/admin/admins/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleChangePassword = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:5002/api/admin/change-password', passwordData, {
        headers: { Authorization: `Bearer ${token}` }
      });
